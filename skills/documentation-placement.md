...
Put domain standards in the workspace standards repository.
A skill points to the document holding domain facts instead of restating them.
Document a repository's own structure inside that repository.
